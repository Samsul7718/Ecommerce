  ...
  return (
    ...
    <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-sky-100 pt-6 p-4'>
         ...
         />
           <ClientCard2
         title={"Furniture"}
         subTitle={"New designed  daily essential furniture products for your daily essential"}
         items={Electronic1}
         viewPage={'/furniture'}
         />
            <ClientCard2
         title={"Juwelry"}
         subTitle={"Introducing daily essential  newly arrived juwelry products for your daily essential"}
         items={Electronic1}
         viewPage={'/juwelry'}
         />
    </section>
