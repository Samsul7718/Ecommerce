...
const Client2 = () => {
  ...
  return (
    ...
    <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-sky-100 pt-6 p-4'>
         ...
         <ClientCard2
         title={"Mobile"}
         subTitle={"Explore the newest mobile phones with advanced features and sleek design"}
         ...
         subTitle={"Introducing new electronic daily essential  product for your needs"}
         items={products.filter(p=>p.category==="electronic")}
         viewPage={'/electronic'}
         />
          <ClientCard2
         title={"Grocery"}
         subTitle={"Discover fresh grocery item for your daily needs"}
         items={Electronic1}
         viewPage={'/grocery'}
         />
          {/* <ClientCard2
