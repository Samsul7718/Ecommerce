...
const Client2 = () => {
  ...
  return (
    ...
    <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-sky-100 pt-6 p-4'>
         <ClientCard2
         title={"Laptop"}
         subTitle={"Discover the latest laptop with powerful performance and sleeks design for works and entertainment"}
         items={products.filter(p=>p.category==="laptop")}
         viewPage={'/laptop'}
         />
         <ClientCard2
         title={"Mobile"}
         subTitle={"Explore the newest mobile phones with cutting-edge features designs connectivity"}
         items={products.filter(p=>p.category==="mobile")}
         viewPage={'/mobile'}
         />
         <ClientCard2
         title={"Vanity"}
         subTitle={"Discover our collection of stylish vanity products to enhance yours beauty routine"}
         ...
         />
          <ClientCard2
         title={"Grocery"}
         subTitle={"Discover fresh and high-quality grocery products for your daily needs"}
         items={Electronic}
         viewPage={'/grocery'}
         />
          <ClientCard2
