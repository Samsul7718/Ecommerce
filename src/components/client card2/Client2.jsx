...
const Client2 = () => {
  ...
  return (
    ...
    <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-sky-100 pt-6 p-4'>
         <ClientCard2
         title={"Laptop"}
         subTitle={"Discover the latest laptops with powerful performance and sleek designs for work"}
         items={products.filter(p=>p.category==="laptop")}
         viewPage={'/laptop'}
         />
         <ClientCard2
         title={"Mobile"}
         subTitle={"Explore the newest mobile phones with cutting-edge features and sleek designs connectivity"}
         items={products.filter(p=>p.category==="mobile")}
         viewPage={'/mobile'}
         />
         <ClientCard2
         title={"Vanity"}
         subTitle={"Discover our collection of stylish vanity products to enhance your beauty routine elevate your personal style"}
         items={products.filter(p=>p.category==="vanity")}
         viewPage={'/vanity'}
         />
         <ClientCard2
         title={"Electronic_daily"}
         subTitle={"Introducing newly arrived electronic products for your daily"}
         ...
         />
           <ClientCard2
         title={"Furniture"}
         subTitle={"New designed  daily essential furniture products for your"}
         items={Electronic1}
         viewPage={'/furniture'}
         />
            <ClientCard2
         title={"Juwelry"}
         subTitle={"Introducing daily essential  newly arrived juwelry products for yours"}
         items={Electronic1}
         viewPage={'/juwelry'}
         />
    </section>
