...
const Client2 = () => {
  ...
  return (
    ...
    <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-sky-100 pt-6 p-4'>
         <ClientCard2
         title={"Laptop"}
         subTitle={"Discover the latest laptop with powerful performance and sleeks design for work"}
         ...
         subTitle={"Introducing newly arrived electronic products for your daily essential need and lifestyle"}
